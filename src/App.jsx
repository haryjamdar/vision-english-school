...
function App() {
  ...
  // Claude db capability — syncs Notices, Site Info, and Gallery across devices
  // for signed-in Claude users who open this artifact link.
  ...
  const handleAdminLogin = (e) => {
    e.preventDefault();
    if (adminPassword === 'VISION@761') {
      setIsAdminLoggedIn(true);
      setAdminLoginError('');
    } else {
      setAdminLoginError('Incorrect password. Please use VISION@761');
    }
  };
